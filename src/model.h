...
private:
	...
	vector<int> nl; // k: number of times that a word is associated with sentiment label l
	...
	// k: typing-jst model L x T
	vector<vector<double> > theta_lz;
	...
	void compute_theta_lz(); // k: for typing-JST model, compute theta_lz instead of theta_dlz
	...
	int save_model_theta_lz(string filename); // k: for typing-JST model, save theta_lz
};
